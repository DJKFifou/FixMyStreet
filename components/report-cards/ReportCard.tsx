...
const ReportCard = ({
  report: { created_at, description, lat, lon, category },
  selectedReport,
  setSelectedReport,
}: {
  report: ReportType;
  ...
  const isOverlayCard = Boolean(selectedReport && setSelectedReport);
  const [isModalOpen, setIsModalOpen] = useState(false);
  const report =
    selectedReport ||
    ({ created_at, description, lat, lon, category } as ReportType);
